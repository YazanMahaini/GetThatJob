...
1. **Set up and check the workspace.** On first use in that workspace, it asks once for your email plugin and submission preference, then creates only missing folders and blank records. If you choose automatic submission, it also asks whether you want to select jobs individually or set an explicit rule for which jobs it may apply to. It **pauses so you can add your CVs and other documents**. When you say to continue, it checks the available sources and asks about your job goals. You may also share your LinkedIn profile link as another source. If your CVs have different designs, it asks which of your own CVs should set the style. Existing workspaces keep their files and resume without a new first-use pause.
